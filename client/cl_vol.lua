...
RegisterKeyMapping('volumeUp', 'Augmenter volume', 'keyboard', Config.VolUpKey)
RegisterKeyMapping('volumeDown', 'Diminuer Volume', 'keyboard', Config.VolDownKey)
...
if Config.Salty then -- Salty compatibilité  
    volume = exports['saltychat']:GetRadioVolume()
    channel = exports['saltychat']:GetRadioChannel()
else
    volume = exports['pma-voice']:GetRadioVolume() -- PMA
